...
This bundle creates dynamic finder services that allows you to query Typesenses
...
The **TypesenseQuery** takes 2 arguments :

* The search terme (q)
* The fields to search on (queryBy)# ACSEOTypesenseBundle
